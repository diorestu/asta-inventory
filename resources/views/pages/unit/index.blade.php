        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a class="modal-effect btn btn-secondary d-flex align-items-center gap-2" data-bs-effect="effect-scale"
                    data-bs-toggle="modal" href="#modaldemo8"><i class="ti ti-plus"></i>Tambah Satuan</a>
        ...
        <x-datatable>
            ...
            <thead class="">
                <tr>
                    ...
                    <th class="text-center">Akronim</th>
        ...
        $(document).ready(function () {
            ...
            let table = $('#myTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'name', name: 'name' },
                    { data: 'short', name: 'short', class: "text-center" },
